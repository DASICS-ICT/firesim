...
class XilinxVCU128InstanceDeployManager(InstanceDeployManager):
    """This class manages a Xilinx VCU128-enabled instance using the
    garnet shell."""
    ...
    def __init__(self, parent_node: Inst) -> None:
        super().__init__(parent_node)
        self.PLATFORM_NAME = "xilinx_vcu128"
    ...
    def enumerate_fpgas(self, uridir: str) -> None:
        """FPGAs are enumerated already with VCU128's"""
        return

    def terminate_instance(self) -> None:
        """XilinxVCU128InstanceDeployManager machines cannot be terminated."""
        return
